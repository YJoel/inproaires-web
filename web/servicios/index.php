...
<head>
  ...
  <meta name="description"
    content="Conoce nuestro portafolio de servicios en climatización: desde la inmunización anticorrosiva hasta la reparación especializada. Atención profesional y oportuna.">
  ...
  <div class="container-fluid">
    ...
    <div class="row" id="content">
      <div class="row section">
        <div class="background">
          <img src="./../img/servicios_background.jpg" alt="" />
        </div>
        <div class="content">
          <div class="title">
            <h1 class="caption">SERVICIOS</h1>
          </div>
      ...
      <div class="row section">
        <div class="background">
          <img src="./../img/servicios1.avif" alt="" />
        </div>
        <div class="content">
          <div class="title">
          ...
          <div class="puntos">
            <div class="punto">
              ...
              Configuración óptima para reducir el consumo eléctrico y mejorar el
            ...
            <div class="punto">
              ...
              Instalaciones con materiales de calidad que minimizan el desgaste y
              prolongan la vida útil del aire acondicionado.
            </div>
            <div class="punto">
              <div class="snow text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-snow2"
                  viewBox="0 0 16 16">
                  <path
              ...
              Garantía de una climatización adecuada desde el primer uso, sin
              problemas de distribución del aire ni ruido excesivo.
            </div>
            <div class="punto">
              <div class="snow text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              Cumplimiento de normas técnicas para evitar riesgos eléctricos y
              estructurales.
            </div>
          </div>
        </div>
      ...
      <div class="row section">
        <div class="background">
          <img src="./../img/mantenimiento_preventivo.jpg" alt="" />
        </div>
        <div class="content">
          <div class="title">
          ...
          <div class="puntos">
            <div class="punto">
              ...
              Intervenciones programadas para evitar fallas mayores y prolongar el
            ...
            <div class="punto">
              ...
              Evaluación continua para identificar componentes desgastados o mal
              funcionamiento antes de que se conviertan en problemas costosos
            </div>
            <div class="punto">
              <div class="snow text-white">
              ...
              Limpieza de filtros y serpentines que mejora la calidad del aire y
              elimina focos de bacterias o moho
            </div>
          </div>
        </div>
      </div>
      <div class="row section">
        <div class="background">
          <img src="./../img/suministro_asesorias.avif" alt="" />
        </div>
        <div class="content">
          <div class="title">
            <h2>SUMINISTRO Y ASESORIAS TÉCNICAS</h2>
          </div>
          <div class="puntos">
            <div class="punto">
              <div class="snow text-white">
              ...
              Acceso a marcas reconocidas y componentes certificados que garantizan
              compatibilidad y rendimiento óptimo.
            </div>
            <div class="punto">
              <div class="snow text-white">
              ...
              Asesorías especializadas que ayudan a seleccionar el equipo más adecuado
              según la necesidad real del cliente.
            </div>
            <div class="punto">
              <div class="snow text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              Evita compras innecesarias y favorece soluciones eficientes a largo
              plazo.
            </div>
            <div class="punto">
              <div class="snow text-white">
              ...
              Acompañamiento en la planeación y mejora de sistemas existentes para
      ...
      <div class="row section">
        <div class="background">
          <img src="./../img/reparacion_equipos.avif" alt="" />
        </div>
        <div class="content">
          <div class="title">
          ...
          <div class="puntos">
            <div class="punto">
              ...
              Solución ágil de fallas que permite recuperar la climatización sin
              demoras prolongadas
            </div>
            <div class="punto">
              <div class="snow text-white">
              ...
              Diagnóstico técnico que prioriza la reparación eficiente frente a la
            ...
            <div class="punto">
              ...
              Evaluación no solo del componente afectado, sino del sistema completo
            ...
            <div class="punto">
              ...
              Reparaciones realizadas bajo protocolos técnicos seguros, con garantía
      ...
      <div class="row section">
        <div class="background">
          <img src="./../img/inmunizacion.jpg" alt="" />
        </div>
        <div class="content">
          <div class="title">
            <h2>INMUNIZACION ANTICORROSIVA</h2>
          </div>
          <div class="puntos">
            <div class="punto">
              <div class="snow text-white">
              ...
              Protege los componentes expuestos (como serpentines, gabinetes y
              bandejas) contra la corrosión provocada por ambientes salinos o
              contaminados.
            </div>
            <div class="punto">
              <div class="snow text-white">
              ...
              Al prevenir el desgaste prematuro, disminuye la necesidad de
              reparaciones y recambios frecuentes.
            </div>
            <div class="punto">
              <div class="snow text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              Al mantener las superficies limpias y libres de corrosión, el equipo
              conserva su capacidad de intercambio térmico.
            </div>
            <div class="punto">
              <div class="snow text-white">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              Uso de pinturas o recubrimientos con tecnología especializada (como ES2
              con pigmentos de acero inoxidable) que crean una barrera eficaz ante
              agentes corrosivos.
            </div>
            <div class="punto">
              <div class="snow text-white">
              ...
              Ideal para zonas costeras, donde la exposición salina puede reducir
    ...
    <div class="row footer">
            ...
            <div class="row">
              <div class="row">
                ...
                <div class="col">
                  ...
                  <div class="row">
                    <div class="col">
                      <a href="mailto:inproairescolombia@gmail.com">inproairescolombia@gmail.com</a>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="col-3">
        ...
        <div class="whatsapp">
          <form name="wa-message" class="wa-message">
