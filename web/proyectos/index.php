...
<head>
  ...
  <meta name="description"
    content="Explora nuestros casos de éxito en climatización para residencias, comercios e industrias. Resultados confiables y personalizados.">
</head>
    ...
    <div class="row" id="content">
      <div class="row section">
        <div class="background">
          <img src="./../img/fondo_tuberias_ventilacion.jpg" alt="" id="background"/>
        </div>
        <div class="content">
          <div class="title">
