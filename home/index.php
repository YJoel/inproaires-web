...
<head>
  ...
  <link rel="stylesheet" href="http://localhost:3000/home/css/styles.css">
</head>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="?page=home">Inicio</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="?page=servicios">Servicios</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="?page=proyectos">Proyectos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="?page=contactanos">Contactanos</a>
            </li>
          </ul>
        </div>
      </div>
